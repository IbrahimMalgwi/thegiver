        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3 text-sm text-white/80">
              <a className="inline-flex items-center gap-3 transition hover:text-accent" href={`mailto:${footer.contact.email}`}>
                <Mail aria-hidden="true" size={18} className="shrink-0" />
                <span className="break-all">{footer.contact.email}</span>
              </a>
              <a className="inline-flex items-center gap-3 transition hover:text-accent" href={phoneHref}>
